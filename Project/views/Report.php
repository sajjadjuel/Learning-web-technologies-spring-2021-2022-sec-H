...
<html>
	...
	<body>
		...
		<form method="POST" action="../controller/ReportCheck.php">
			<center>
				<fieldset style="height:80%;width:50%;border-width:10px;border-color:mediumseagreen;">
				<legend style="color:green; font-size:50;margin: 10%; text-align:left; " ><b>Report</b></legend>
					<table align="center" width="80%" >
						<tr>
							<td style="color:green;font-size:20;"><b>Describe Problem</b></td>
							<td width="50%">
								<textarea>
								</textarea>
							</td>
						...
						<tr>
							<td style="color:green;font-size:20;"><b>Report Under </b></td>
							<td>
						...
						<tr>
							<td colspan="2" align="center" >
								<input type="submit" name="report" value="Report" style="background-color: mediumseagreen; color: white; font-size:30; font-family:Times New Roman;width:80%;">
							</td>
						</tr>
					</table>
				</fieldset>
